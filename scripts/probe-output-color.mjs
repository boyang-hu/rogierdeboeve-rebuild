...
async function runProbe() {
  ...
  if (!visibleP1Items.every((item) => item.sourceUCoordsMode === "source-VA-XA-update-Pe-width-height-times-capped-dpr-direct-no-rebuild-Math.max-clamp")) {
  ...
  if (!visibleP1Items.every((item) => item.sourceUCoordsDirectViewportMatches === true)) {
    cullingErrors.push("sourceUCoordsDirectViewportMatches");
  }
