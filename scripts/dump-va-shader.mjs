...
function analyzeVertexCore(sourceShader, rebuildShader) {
  ...
  const checks = {
    ...
    sourceSpotlightMapVertexPars: ["#include<shadowmap_pars_vertex>"],
    sourceSpotlightMapVertexCoords: ["#include<shadowmap_vertex>"],
...
function analyzeVaFragmentCore(sourceShader, rebuildShader) {
  ...
  const checks = {
    ...
    sourceSpotlightMapFragmentLighting: ["#include<lights_fragment_begin>"],
