...
Status: partially implemented. Core setter ownership is source-shaped; project, home, and about entry timing are closer to source; about leave/destroy cleanup is closer to source; home gallery leave still needs a final pass.
