...
Current next batch: continue Phase 1 Home WebGL. Prioritize source-backed work in this order: remaining `VA/GA` output and spotlight/thumb projection evidence, then unresolved `A1/OA/kA/Lu` transfer/target graph evidence, while keeping project pages as regression gates. Phase 2 should not start yet.
