...
- `A1/OA/kA/Lu/I1` are source-shaped in pieces and now have source-shaped `nD/Iu/Lu/I1/Lo` update sequencing plus `Lo/Lu/I1` render-target clone ownership and pass-material ownership, but transfer interpretation and composite behavior are still not byte-for-byte source-isomorphic.
