...
Decision: keep source `p1` root direct-child order as lights -> aboutBlocks -> floatingBlocks -> sceneWrap. This closes one hierarchy/add-order mismatch only; Phase 1 remains open for spotlight/thumb projection transfer feel, broader `kA/Lu/I1` transfer/composite interpretation, floor/environment residuals, and the source-equivalent GPU/LOW_RES bridge.
